...
export default {
  ...
  computed: {
    ...
    projectDSN(){
      return `${window.Bugphix.dsn}/${this.projectItem.project_id}/${this.projectItem.project_token}`;
    },
    projectIssues(){
      return '1,500 issues recorded';
    },
    projectEvents(){
      return '105k events recorded';
    },
    projectUpdated(){
